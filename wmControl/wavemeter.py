...
class Wavemeter:
    ...
    @_lock_wavemeter
    async def get_calibration_ba_0(self):
        return await self.__wrapper(wlmData.get_calibration_ba_0)


    @_lock_wavemeter
    async def get_calibration_dif(self):
        return await self.__wrapper(wlmData.get_calibration_dif)
