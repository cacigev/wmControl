...
def LoadDLL(path):
    ...
    dll.SetSwitcherSignalStates.argtypes = [
        ctypes.c_int32,
        ctypes.c_int32,
        ctypes.c_int32,
    ]
    ...
    dll.GetAveragingSettingNum.argtypes = [
        ctypes.c_int32,
        ctypes.c_int32,
        ctypes.c_int32,
    ]
    ...
    dll.SetAveragingSettingNum.argtypes = [
        ctypes.c_int32,
        ctypes.c_int32,
        ctypes.c_int32,
    ]
...
def get_wavelength(dll: ctypes.WinDLL | ctypes.CDLL, channel: int) -> Decimal:
    ...
    return Decimal(result) * Decimal("10e-9")  # Result in m
...
def get_frequency(dll: ctypes.WinDLL | ctypes.CDLL, channel: int) -> Decimal:
    ...
    return Decimal(result) * Decimal("10e12")  # Result in Hz
